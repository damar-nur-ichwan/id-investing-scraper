...
exports.default = (EquityGeneralURL) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let tempArray = [];
    let different = false;
    const { year, month, date, hours } = (0, get_indonesia_time_1.default)();
    const value = {
        code: "",
        name: "",
        volume: 0,
        ...
        change: 0,
        status: "",
        createdAt: parseInt(`${year}${month < 10 ? "0" + month : month}${date < 10 ? "0" + date : date}${hours < 10 ? "0" + hours : hours}`),
    };
    try {
        ...
        if (different) {
            ...
            $(".instrument-price_instrument-price__xfgbB .text-2xl").each(function (i, e) {
                tempAny = $(e).first().text();
        ...
        //status
        $(".instrument-tech-summary_instrument-tech-summary__GLtIo").each(function (i, e) {
            if (different) {
...
//# sourceMappingURL=ScrapeTechnicalSummaryHourly.js.map